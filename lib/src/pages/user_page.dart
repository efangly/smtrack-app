...
class _UserPageState extends State<UserPage> {
  ...
  Widget build(BuildContext context) {
    TextStyle labelStyle = TextStyle(fontWeight: FontWeight.w500, fontSize: Responsive.isTablet ? 20 : 16, color: Colors.white70);
        ...
        child: CustomAppbar(
          titleInfo: Row(
            ...
            children: [
              ...
              Text('บัญชี', style: TextStyle(fontSize: Responsive.isTablet ? 24 : 20, fontWeight: FontWeight.w900)),
                ...
                return SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          FaIcon(FontAwesomeIcons.userGroup, size: Responsive.isTablet ? 38 : 28, color: Colors.white70),
                      ...
                      TextField(
                        ...
                        style: TextStyle(fontSize: Responsive.isTablet ? 26 : 20, fontWeight: FontWeight.w500, color: Colors.white70),
                        decoration: InputDecoration(
                          ...
                          suffixIcon: IconButton(
                            ...
                            icon: FaIcon(FontAwesomeIcons.pencil, size: Responsive.isTablet ? 38 : 28, color: Colors.white70),
                          ),
                        ),
                      ),
                      SizedBox(height: Responsive.isTablet ? 20 : 10),
                      Row(
                        children: [
                          FaIcon(FontAwesomeIcons.userLock, size: Responsive.isTablet ? 38 : 28, color: Colors.white70),
                          const SizedBox(width: 8),
                          Text(
                            "แก้ไขรหัสผ่าน",
                            style: TextStyle(fontSize: Responsive.isTablet ? 24 : 20, fontWeight: FontWeight.bold, color: Colors.white70),
                          ),
                        ],
                      ),
                      Form(
                              ...
                              children: [
                                TextButton.icon(
                                  ...
                                  label: Text(
                                    "แก้ไข",
                                    style: TextStyle(
                                        fontSize: Responsive.isTablet ? 24 : 18, color: Colors.white70, fontWeight: FontWeight.bold),
                                  ),
                                  icon: FaIcon(FontAwesomeIcons.key, size: Responsive.isTablet ? 38 : 28, color: Colors.white70),
                                ),
                                SizedBox(width: Responsive.isTablet ? 30 : 20),
                                TextButton.icon(
                                  ...
                                  icon: FaIcon(FontAwesomeIcons.trash, size: Responsive.isTablet ? 38 : 28, color: Colors.white70),
                                  style: ButtonStyle(
                                    shape: WidgetStateProperty.all(
                                      RoundedRectangleBorder(
                                        borderRadius: BorderRadius.circular(10),
                      ...
                      TextButton.icon(
                        ...
                        icon: Icon(Icons.delete_forever, size: Responsive.isTablet ? 40 : 30, color: Colors.red[500]),
                      ),
                    ],
                  ),
                );
